...
## Data download
一部の非公開データを除いて、MicrobeDB.jpで用いている全てのRDFデータは[NBDC DBアーカイブ](https://dbarchive.biosciencedbc.jp/en/microbedb/desc.html)からダウンロードできます。
詳細は、[リンク先](https://github.com/MicrobeDBjp/document/blob/master/DataDetail.md)に記述してあります。
